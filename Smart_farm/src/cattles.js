...
const productsData = [
    {
        name: "ECOWEALTH MILKING BUCKET ASSEMBLY FOR CATTLES",
        price: 100,
        description: "20 lit SS 304 bucket with SS lid, Melasty Pulsator, claw(160 CC), liner (Short Liner), transparent teat sell , short tube, pulse tube, Milk tube (4') & vacuum tube (10'), Liner Cleaning Brush, Milktube Cleaning brush",
        image: 'https://www.bighaat.com/cdn/shop/products/mb20_800x.jpg?v=1628479986',
        id: 1,
    },
    {
        name: "Root-Boost",
...

    {
        ...
        image: 'https://www.bighaat.com/cdn/shop/products/Untitled_2_500x_8c9805af-dee4-4556-bb0f-42af6f3729f8_200x.webp?v=1678793600',
        id: 3,
    },
    {
        name: "Rimon",
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    addToCartButtons.forEach(button => {
        button.addEventListener("click", event => {
            ...
            if (!addToCartButtons) {
                window.location.href = '../components/vermicompost.html?productId=${1}';
            }
        });
    });
